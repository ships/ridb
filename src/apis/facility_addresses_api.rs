...
pub struct FacilityAddressesApiClient {
    configuration: Rc<configuration::Configuration>,
}

impl FacilityAddressesApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> FacilityAddressesApiClient {
