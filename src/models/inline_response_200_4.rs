...
pub struct InlineResponse2004 {
  ...
  RECDATA: Option<Vec<::models::FacilityAddress>>
}
...
impl InlineResponse2004 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::FacilityAddress>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::FacilityAddress>) -> InlineResponse2004 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::FacilityAddress>> {
    self.RECDATA.as_ref()
  }
