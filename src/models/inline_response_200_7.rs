...
pub struct InlineResponse2007 {
  ...
  RECDATA: Option<Vec<::models::Tour>>
}
...
impl InlineResponse2007 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Tour>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Tour>) -> InlineResponse2007 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Tour>> {
    self.RECDATA.as_ref()
  }
