...
pub struct InlineResponse2001 {
  ...
  RECDATA: Option<Vec<::models::RecreationArea>>
}
...
impl InlineResponse2001 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::RecreationArea>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::RecreationArea>) -> InlineResponse2001 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::RecreationArea>> {
    self.RECDATA.as_ref()
  }
