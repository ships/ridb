...
pub struct InlineResponse2005 {
  ...
  RECDATA: Option<Vec<::models::Campsite>>
}
...
impl InlineResponse2005 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Campsite>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Campsite>) -> InlineResponse2005 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Campsite>> {
    self.RECDATA.as_ref()
  }
