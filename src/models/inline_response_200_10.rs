...
pub struct InlineResponse20010 {
  ...
  RECDATA: Option<Vec<::models::Zone>>
}
...
impl InlineResponse20010 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Zone>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Zone>) -> InlineResponse20010 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Zone>> {
    self.RECDATA.as_ref()
  }
