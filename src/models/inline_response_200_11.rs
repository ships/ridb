...
pub struct InlineResponse20011 {
  ...
  RECDATA: Option<Vec<::models::Event>>
}
...
impl InlineResponse20011 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Event>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Event>) -> InlineResponse20011 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Event>> {
    self.RECDATA.as_ref()
  }
