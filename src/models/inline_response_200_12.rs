...
pub struct InlineResponse20012 {
  ...
  RECDATA: Option<Vec<::models::Link>>
}
...
impl InlineResponse20012 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Link>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Link>) -> InlineResponse20012 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Link>> {
    self.RECDATA.as_ref()
  }
