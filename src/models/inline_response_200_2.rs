...
pub struct InlineResponse2002 {
  ...
  RECDATA: Option<Vec<::models::Facility>>
}
...
impl InlineResponse2002 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Facility>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Facility>) -> InlineResponse2002 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Facility>> {
    self.RECDATA.as_ref()
  }
