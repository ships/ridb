...
pub struct InlineResponse2009 {
  ...
  RECDATA: Option<Vec<::models::Attribute>>
}
...
impl InlineResponse2009 {
  ...
  pub fn set_RECDATA(&mut self, RECDATA: Vec<::models::Attribute>) {
    self.RECDATA = Some(RECDATA);
  }

  pub fn with_RECDATA(mut self, RECDATA: Vec<::models::Attribute>) -> InlineResponse2009 {
    self.RECDATA = Some(RECDATA);
    self
  }

  pub fn RECDATA(&self) -> Option<&Vec<::models::Attribute>> {
    self.RECDATA.as_ref()
  }
